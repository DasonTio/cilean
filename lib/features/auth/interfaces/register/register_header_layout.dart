...
class RegisterHeaderLayout extends StatefulWidget {
  const RegisterHeaderLayout({Key? key, required this.controller})
      : super(key: key);
  final AnimationController controller;
  @override
  _RegisterHeaderLayoutState createState() => _RegisterHeaderLayoutState();
}

class _RegisterHeaderLayoutState extends State<RegisterHeaderLayout> {
